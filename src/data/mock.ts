...
export const mockProfessionals: Professional[] = [
  ...
  },
  {
    ...
    portfolio: [
      {
        id: 'sinq_p1',
        title: 'Strategic Digital Solutions Delivery',
        description: 'Delivered innovative digital solutions for Ethiopian Investment Holdings (EIH), Ethiopian Construction Works Corporation (ECWC), WELL Mental Health, Dynem Chemicals, and EHTDASS, focusing on practical, scalable, and sustainable outcomes.',
