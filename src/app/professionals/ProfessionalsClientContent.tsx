...
export function ProfessionalsClientContent() {
    ...
    <div className="space-y-8">
      <div>
        ...
        {activeFilterTopic && !isLoading && (
          <h2 className="text-2xl font-semibold text-primary mb-1"> {/* Changed from text-accent */}
...
// It's good practice to also wrap the part that uses useSearchParams in a Suspense for granular control
// For this specific case, the entire ProfessionalsClientContent uses it.
// If you had a static part and a dynamic part, you'd wrap only the dynamic part.
export default function ProfessionalsClientContentWrapper() {
  return (
    <Suspense fallback={<div>Loading Xperts and filters...</div>}>
      <ProfessionalsClientContent />
    </Suspense>
  )
}
